...
function exibir(){
    ...
    board.innertHTML = tabela

}

function jogar(){
    aviso.innertHTML = 'Vez do jogador: ' + numeroJogador()
    ...
    if (tabuleiro[linha][coluna] == 0) {
        ...
        aviso.innertHTML = 'Esse campo já foi marcado'
    }
...
function checar(){
    for (let i = 0; i < 3; i++){
        ...
        if (soma == 3 || soma == -3){
            aviso.innertHTML = 'O jogador ' + numeroJogador() + 'ganhou!'
